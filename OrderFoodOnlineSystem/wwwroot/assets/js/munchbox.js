...
(function ($) {
    ...
    $(document).ready(function () {
        ...
        // like dislike
        $('.circle-tag button, .add-fav button, .add-wishlist button').on('click', function () {

            console.log("//////////////////////////////");
            console.log('Clicked:', $(this).attr('data-favorite'));


            const isFavorite = $(this).data('favorite'); // Get current state

            // Toggle classes and attributes based on the state
            if (isFavorite) {
                $(this)
                    .removeClass('favorite')
                    .addClass('not-favorite')
                    .data('favorite', false)
                    .attr('aria-label', 'Add to favorites');
            } else {
                $(this)
                    .removeClass('not-favorite')
                    .addClass('favorite')
                    .data('favorite', true)
